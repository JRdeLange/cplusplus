...
int main()
{
	...
	/*Becouse integers have to be whole numbers, an odd number divided by 2 will be rounded. This means
	that */			

	cout << (value & 1 ? "odd" : "even") << '\n';				
	/*By using the Bitwise AND over value and 1, we are checking whether value in binairy starts with a 1.
	 If so then value has to be odd*/
